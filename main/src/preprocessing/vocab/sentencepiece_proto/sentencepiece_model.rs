...
// These rust bindings have been modified from their original version at https://github.com/google/sentencepiece/blob/master/src/sentencepiece_model.proto
...
impl TrainerSpec {
    ...
    // Param is passed by value, moved
    pub fn set_user_defined_symbols(
        &mut self,
    ...
    // Mutable pointer to the field.
    pub fn mut_user_defined_symbols(
        &mut self,
    ...
    // Take field
    pub fn take_user_defined_symbols(
        &mut self,
...
impl ::protobuf::Message for TrainerSpec {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeEnum<TrainerSpec_ModelType>,
                >(
                    "model_type",
    ...
    fn default_instance() -> &'static TrainerSpec {
        ...
        unsafe { instance.get(TrainerSpec::new) }
    }
}
...
impl ::protobuf::ProtobufEnum for TrainerSpec_ModelType {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new_pb_name::<TrainerSpec_ModelType>(
...
impl ::protobuf::Message for NormalizerSpec {
            ...
            match field_number {
                ...
                6 => {
                    ::protobuf::rt::read_singular_string_into(
                        wire_type,
                        is,
                        &mut self.normalization_rule_tsv,
                    )?;
                }
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(
    ...
    fn default_instance() -> &'static NormalizerSpec {
        ...
        unsafe { instance.get(NormalizerSpec::new) }
    }
}
...
impl ::protobuf::Message for SelfTestData {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<SelfTestData_Sample>,
                    >(
                        "samples",
    ...
    fn default_instance() -> &'static SelfTestData {
        ...
        unsafe { instance.get(SelfTestData::new) }
    }
}
...
impl ::protobuf::Message for SelfTestData_Sample {
    ...
    fn default_instance() -> &'static SelfTestData_Sample {
        static mut instance: ::protobuf::lazy::Lazy<SelfTestData_Sample> =
            ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(SelfTestData_Sample::new) }
    }
}
...
impl ModelProto {
    ...
    pub fn get_trainer_spec(&self) -> &TrainerSpec {
        self.trainer_spec
            .as_ref()
            .unwrap_or_else(|| TrainerSpec::default_instance())
    }
    ...
    pub fn take_trainer_spec(&mut self) -> TrainerSpec {
        self.trainer_spec
            .take()
            .unwrap_or_else(|| TrainerSpec::new())
    }
    ...
    pub fn get_normalizer_spec(&self) -> &NormalizerSpec {
        self.normalizer_spec
            .as_ref()
            .unwrap_or_else(|| NormalizerSpec::default_instance())
    }
    ...
    pub fn take_normalizer_spec(&mut self) -> NormalizerSpec {
        self.normalizer_spec
            .take()
            .unwrap_or_else(|| NormalizerSpec::new())
    }
    ...
    pub fn get_self_test_data(&self) -> &SelfTestData {
        self.self_test_data
            .as_ref()
            .unwrap_or_else(|| SelfTestData::default_instance())
    }
...
impl ::protobuf::Message for ModelProto {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<ModelProto_SentencePiece>,
                    >(
                        "pieces",
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<TrainerSpec>,
                    >(
                        "trainer_spec",
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<NormalizerSpec>,
                    >(
                        "normalizer_spec",
                ...
                fields.push(
                    ::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
                        _,
                        ::protobuf::types::ProtobufTypeMessage<SelfTestData>,
                    >(
                        "self_test_data",
    ...
    fn default_instance() -> &'static ModelProto {
        ...
        unsafe { instance.get(ModelProto::new) }
    }
}
...
impl ModelProto_SentencePiece {
    ...
    pub fn get_field_type(&self) -> ModelProto_SentencePiece_Type {
        self.field_type
            .unwrap_or(ModelProto_SentencePiece_Type::NORMAL)
    }
...
impl ::protobuf::Message for ModelProto_SentencePiece {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeEnum<ModelProto_SentencePiece_Type>,
                >(
                    "type",
    ...
    fn default_instance() -> &'static ModelProto_SentencePiece {
        static mut instance: ::protobuf::lazy::Lazy<ModelProto_SentencePiece> =
            ::protobuf::lazy::Lazy::INIT;
        unsafe { instance.get(ModelProto_SentencePiece::new) }
    }
}
...
impl ::protobuf::ProtobufEnum for ModelProto_SentencePiece_Type {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new_pb_name::<ModelProto_SentencePiece_Type>(
