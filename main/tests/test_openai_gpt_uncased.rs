    ...
    let expected_results = [
        ...
        TokenizedInput {
            ...
            token_offsets: vec!(Some(Offset { begin: 0, end: 9 }), Some(Offset { begin: 10, end: 13 }), Some(Offset { begin: 14, end: 18 }), Some(Offset { begin: 19, end: 23 }),
                                Some(Offset { begin: 24, end: 27 }), Some(Offset { begin: 28, end: 30 }), Some(Offset { begin: 30, end: 33 }), Some(Offset { begin: 33, end: 37 }),
                                Some(Offset { begin: 38, end: 39 }), Some(Offset { begin: 40, end: 41 })),
            reference_offsets: vec!(),
            mask: vec!(),
        },
        TokenizedInput {
