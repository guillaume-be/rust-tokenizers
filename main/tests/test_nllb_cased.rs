...
fn test_nllb_tokenization() -> anyhow::Result<()> {
    ...
    let original_strings = [
        "nld_Latn …",
        "eng_Latn This is a sample sentence to be tokénized",
    ...
    let expected_results = [
        TokenizedInput {
            token_ids: vec![256127, 622, 2, 256047],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
            num_truncated_tokens: 0,
            token_offsets: vec![
                Some(Offset { begin: 0, end: 8 }),
        ...
        TokenizedInput {
            token_ids: vec![
                256047, 9680, 248, 9, 183824, 109267, 202, 280, 1776, 107717, 18755, 2, 256047,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
        ...
        TokenizedInput {
            token_ids: vec![
                ...
                10117, 2139, 248701, 69085, 100655, 2, 256047,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
        ...
        TokenizedInput {
            token_ids: vec![
                ...
                248059, 248059, 248059, 248059, 248059, 2, 256047,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
        ...
        TokenizedInput {
            token_ids: vec![
                ...
                248059, 248059, 248059, 248059, 2, 256047,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
