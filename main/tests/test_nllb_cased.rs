...
fn test_nllb_tokenization() -> anyhow::Result<()> {
    ...
    let original_strings = [
        ">>nld<< …",
        ">>eng<< This is a sample sentence to be tokénized",
        ">>eng<< Wondering how this will get tokenized 🤔 ?",
        ">>fra<< İs th!s 𩸽 Ϻ Šœ Ugljšić dấu nặng",
        ">>hin<<   İs th!s    𩸽 Ϻ Šœ   Ugljšić  dấu nặng     ",
        ">>lit<< � İs th!s �� 𩸽 Ϻ Šœ   Ugljšić  dấu nặng     ",
    ];

    let expected_results = [
        TokenizedInput {
            token_ids: vec![256326, 622, 2],
            segment_ids: vec![],
        ...
        TokenizedInput {
            token_ids: vec![
                256248, 9680, 248, 9, 183824, 109267, 202, 280, 1776, 107717, 18755, 2,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
            ...
            token_offsets: vec![
                ...
                Some(Offset { begin: 17, end: 24 }),
                Some(Offset { begin: 24, end: 33 }),
                Some(Offset { begin: 33, end: 36 }),
                Some(Offset { begin: 36, end: 39 }),
                Some(Offset { begin: 39, end: 43 }),
                Some(Offset { begin: 43, end: 47 }),
                Some(Offset { begin: 47, end: 50 }),
                None,
            ],
            reference_offsets: vec![],
            mask: vec![],
        ...
        TokenizedInput {
            token_ids: vec![
                256248, 246, 527, 5334, 11657, 3423, 4062, 4023, 1776, 430, 18755, 248059, 254282,
                385, 2,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
        ...
        TokenizedInput {
            token_ids: vec![
                256258, 73808, 233, 248203, 248066, 248059, 3, 248059, 3, 3658, 250500, 12291,
        ...
        TokenizedInput {
            token_ids: vec![
                256269, 73808, 233, 248203, 248066, 248059, 248059, 248059, 248059, 3, 248059, 3,
        ...
        TokenizedInput {
            token_ids: vec![
                256304, 248059, 73808, 233, 248203, 248066, 248059, 248059, 3, 248059, 3, 3658,
