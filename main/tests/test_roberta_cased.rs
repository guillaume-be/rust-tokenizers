...
use rust_tokenizers::{RobertaTokenizer, TokenizedInput, Tokenizer, TruncationStrategy};
...
fn test_roberta_tokenization() -> anyhow::Result<()> {
    ...
    let expected_results = [
        ...
        TokenizedInput {
            token_ids: vec![
                ...
                4654, 118, 4807, 1437, 385, 1376, 3070, 8210, 257, 295, 1376, 3070, 18400, 2590, 2,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
    ...
    let output = roberta_tokenizer.encode_list(
