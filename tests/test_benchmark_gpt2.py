...
class TestBenchmarkGPT2:
    def setup_class(self):
        ...
        self.sentence_list = [
            ...
            'The probabilistic interpretation[24] derives from the field of machine learning. It features inference,[11][12][1][2][17][24] as well as the optimization concepts of training and testing, related to fitting and generalization, respectively',
